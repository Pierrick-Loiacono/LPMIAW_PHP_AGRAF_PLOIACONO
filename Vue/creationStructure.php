                        ...
                        <div id="div_id_select" class="form-group required">
                         ...
                         <div id="div_id_name" class="form-group required">
                            ...
                            <div class="controls col-md-8 ">
                                <input class="input-md  textinput textInput form-control" id="id_name" maxlength="30" name="username" placeholder="nom de l'entreprise" style="margin-bottom: 10px" type="text" />
                            </div>
                        </div>
